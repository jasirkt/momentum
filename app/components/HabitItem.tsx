...
// A robust helper function to format a local date as "YYYY-MM-DD"
// This avoids timezone conversions by building the string from local date parts.
          ...
          return (
            <div key={dateStr} className="flex flex-col items-center gap-1">
              ...
              <div
                ...
                className={`w-9 h-9 sm:w-10 sm:h-10 rounded-md cursor-pointer flex items-center justify-center transition-all
